...
Usage:
    from dlt_sources.language.duchas import duchas_source
...
from observability.logging import get_logger  # noqa: F401 — see _observability_shim.py
from dlt_sources.common._http_factories import duchas_client
...
def _parse_volume_row(row, collection: str) -> dict | None:
    ...
    row.find_all("td") if row.name == "tr" else [row]
